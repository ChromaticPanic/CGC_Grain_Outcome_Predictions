...
def test_remove_inactive_stations():
    ...
    states = [
        {'station_id': '2', 'last_updated': np.datetime64('2010-05-05'), 'is_active': True}, 
        {'station_id': '1', 'last_updated': np.datetime64('2010-05-05'), 'is_active': True}
    ]
    ...
    stations['station_id'] = ['1', '2']
    states = [
        {'station_id': '2', 'last_updated': np.datetime64('2010-05-05'), 'is_active': False}, 
        {'station_id': '1', 'last_updated': np.datetime64('2010-05-05'), 'is_active': False}
    ]
    ...
    states = [
        {'station_id': '2', 'last_updated': np.datetime64('2010-05-05'), 'is_active': False}, 
        {'station_id': '1', 'last_updated': np.datetime64('2010-05-05'), 'is_active': True},
        {'station_id': '3', 'last_updated': np.datetime64('2010-05-05'), 'is_active': False}
    ]
...
def test_add_last_updated_all_values():
    ...
    states = [
        {'station_id': '2', 'last_updated': np.datetime64('2010-05-05'), 'is_active': True}, 
        {'station_id': '1', 'last_updated': np.datetime64('2010-05-05'), 'is_active': True},
        {'station_id': '3', 'last_updated': np.datetime64('2010-05-05'), 'is_active': True}
    ]
...
def test_find_latest_date():
    listOfDates = [np.datetime64('2010-05-05'), np.datetime64('2000-02-01'), np.datetime64('2012-12-05')]
...
def test_find_latest_date_with_invalid_entries():
    listOfDates = [np.datetime64('2010-05-05'), np.datetime64('NaT'), np.datetime64('2000-02-01'), np.datetime64('2012-12-05'), np.datetime64('NaT')]
    latestDate = pd.to_datetime(processor.findLatestDate(listOfDates))
    ...
    listOfDates = [np.datetime64('2010-05-05'), np.datetime64(None), np.datetime64('2000-02-01'), np.datetime64('2012-12-05'), np.datetime64(None)]
    latestDate = pd.to_datetime(processor.findLatestDate(listOfDates))
...
def test_calc_date_range():
    ...
    minYear, maxYear = processor.calcDateRange(firstYearWithData, lastUpdated, lastYearWithData, currentYear)
...
def test_remove_older_than():
    df = pd.DataFrame()
    df['date'] = [np.datetime64('2012-05-06'), np.datetime64('2012-05-05'), np.datetime64('2000-05-05'), np.datetime64('2012-05-07')]
