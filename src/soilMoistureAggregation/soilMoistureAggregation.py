...
load_dotenv()
PG_USER: str | None = os.getenv("POSTGRES_USER")
PG_PW: str | None = os.getenv("POSTGRES_PW")
PG_DB: str | None = os.getenv("POSTGRES_DB")
PG_ADDR: str | None = os.getenv("POSTGRES_ADDR")
PG_PORT: str | None = os.getenv("POSTGRES_PORT")
