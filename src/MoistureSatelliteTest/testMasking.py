...
shapefile_path = '/home/student/bhandar1/CGC_Grain_Outcome_Predictions/src/MoistureSatelliteTest/lpr_000b16a_e.shp'
netcdf_file_path = '/home/student/bhandar1/CGC_Grain_Outcome_Predictions/src/MoistureSatelliteTest/perfectDemo.nc'
...
manitoba = shapefile_reprojected[shapefile_reprojected['PRNAME'] == 'Alberta']
mask = regionmask.mask_geopandas(manitoba, dataset.lon, dataset.lat)
masked_data = dataset.where(mask)

output_csv_file = '/home/student/bhandar1/CGC_Grain_Outcome_Predictions/src/MoistureSatelliteTest/sm_data_demo7_Alberta.csv'
